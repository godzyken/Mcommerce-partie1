...
public class ProductController {
    ...
    public ResponseEntity<Void> ajouterProduit(
            /*@Valid*/ @RequestBody Product product) throws ProduitGratuitException {

        if (product.getPrix() == 0) {

            throw new ProduitGratuitException("0 n'est pas une valeur rentable, voleuuuuur !!");
        }
    ...
    // Récupérer les marges de tous les produits listés
    ...
    public List<String> calculerMargeProduit() {
        ...
        for (Product listeProduit : listeProduits) {
            int marge = listeProduit.getPrix() - listeProduit.getPrixAchat();
            marges.add(listeProduit.toString() + ":" + marge);
        }
        return marges;
    }
    ...
    public List<Product> trierProduitsParOrdreAlphabetique() {
        ...
        List<Product> listeTrieAlphabetique = productDao.findByOrderByNom();

        return listeTrieAlphabetique;
    }
}